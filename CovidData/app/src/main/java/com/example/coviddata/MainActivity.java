            ...
            public void onResponse(Call<String> call, Response<String> response) {
               String res = response.body();
                try {
                    ...
                    conf.setText("Confirmed Cases: "+confirmed);
                    act.setText("Active Cases: "+active);
                    rec.setText("Recovered Cases: "+recovered);
                    dead.setText("Death Cases: "+death);
                    pd.dismiss();
